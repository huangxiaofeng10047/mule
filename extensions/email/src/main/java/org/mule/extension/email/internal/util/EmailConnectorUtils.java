...
public final class EmailConnectorUtils {
  ...
  /**
   * Extracts the incoming {@link MuleMessage} attributes of {@link ReceivedEmailAttributes} type.
   *
   * @param muleMessage the incoming {@link MuleMessage}.
   * @return an {@link Optional} value with the {@link ReceivedEmailAttributes}.
   */
  public static Optional<ReceivedEmailAttributes> getAttributesFromMessage(MuleMessage muleMessage) {
